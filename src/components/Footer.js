...
const Footer = () => {
  return (
    <div className='flex justify-around w-full h-auto bg-moss font-quicksand text-white py-8'>
        <div className=''>
          <p className='font-semibold border-b hover:text-slate-900'>Contact Us:</p>
          <p className='pt-2 hover:text-slate-900'>Email: PsySense@gmail.com</p>
          <p className='pt-2 hover:text-slate-900'>Phone: </p>
        </div>
        <div>
          <p className='font-semibold border-b hover:text-slate-900'>Additional References:</p>
          <p className='pt-2'>
